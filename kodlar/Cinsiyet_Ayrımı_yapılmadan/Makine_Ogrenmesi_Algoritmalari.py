...
df=pd.read_csv('Olusturulan_Excel.csv')


### kişilerin sağlık durumlarının sayısal olarak ifade edilmesi
...
## Adaptive SMOTE yöntemi ile veri çoğaltma
...
def DRAW_ROCCURVE_WITH_SKLEARN_TPR_FPR_VALUES(fpr,tpr,name_of_method): 
...
rf_reg=RandomForestClassifier(n_estimators = 9,random_state=0,criterion='entropy',max_features='log2',max_depth=22) 
...
## Karar Ağacı
r_dt = DecisionTreeClassifier(random_state=0,criterion='entropy',max_features='auto',max_depth=1) 
